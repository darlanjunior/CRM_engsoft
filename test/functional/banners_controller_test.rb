...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { height: @banner.height, name: @banner.name, picture: @banner.picture, size_type: @banner.size_type, width: @banner.width }
    end
  ...
  test "should update banner" do
    put :update, id: @banner, banner: { height: @banner.height, name: @banner.name, picture: @banner.picture, size_type: @banner.size_type, width: @banner.width }
    assert_redirected_to banner_path(assigns(:banner))
  end
