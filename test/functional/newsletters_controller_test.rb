...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { message_body: @newsletter.message_body, send_date: @newsletter.send_date, title: @newsletter.title }
    end
  ...
  test "should update newsletter" do
    put :update, id: @newsletter, newsletter: { message_body: @newsletter.message_body, send_date: @newsletter.send_date, title: @newsletter.title }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
